...
`,
		...
		{
			name:      "bool arg passed without value",
			input:     args("-p", "testdata/project", "run", "bool_arg", "--silent"),
			stdoutput: "silent=[true]\n",
			erroutput: "",
			err:       nil,
		},
		{
			name:      "bool arg with space-separated value is not consumed",
			input:     args("-p", "testdata/project", "run", "bool_arg", "--silent", "false"),
			stdoutput: "silent=[true]\n",
			erroutput: "",
			err:       nil,
		},
		{
			name:      "bool arg with explicit false",
			input:     args("-p", "testdata/project", "run", "bool_arg", "--silent=false"),
			stdoutput: "silent=[false]\n",
			erroutput: "",
			err:       nil,
		},
		{
			name:      "bool arg with explicit true",
			input:     args("-p", "testdata/project", "run", "bool_arg", "--silent=true"),
			stdoutput: "silent=[true]\n",
			erroutput: "",
			err:       nil,
		},
		{
			name:      "bool arg unset",
			input:     args("-p", "testdata/project", "run", "bool_arg"),
			stdoutput: "silent=[]\n",
			erroutput: "",
			err:       nil,
		},
